 ...
 <div className= {styles.wrapper}>
    ...
    {change? ( <div className={styles.Staffing_true}>
        ...
        ( <div className={styles.Staffing}>
           ...
           <p style={{color:'white', fontSize: '24px', width: '80%', textAlign:'left',margin: 'auto',  marginLeft: '8%',marginTop:'15px'}}>Подразделение </p>
           <p style={{color:'white', fontSize: '24px', width: '80%', textAlign:'left',margin: 'auto',  marginLeft: '8%',marginTop:'15px'}}>ОРПО </p>
           <ul className={styles.Staffing_desc}>
